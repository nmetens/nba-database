...
create table if not exists 
NBA.Players (
	PLAYER_ID int primary key, -- PK
	SEASON_ID varchar(10) references NBA.Seasons(season_id) on delete cascade, -- FK
	LEAGUE_ID int,
...
NBA.Awards (
	...
	PERSON_ID int references NBA.Players(PLAYER_ID) on delete cascade, -- FK
...
NBA.PlayerGameLogs (
	...
	PLAYER_ID int references NBA.Players(PLAYER_ID) on delete cascade,
	GAME_ID varchar(20),
	GAME_DATE date,
	MATCHUP varchar(50),
	WL varchar(2),
...
-- Table: CommonPlayerInfo
create table if not exists 
NBA.CommonPlayerInfo (
	PERSON_ID int primary key references NBA.Players(PLAYER_ID) on delete cascade,
	FIRST_NAME varchar(50),
	LAST_NAME varchar(50),
